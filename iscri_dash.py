...
class IscriDash:
    ...
    def empty_figure(self):
        ...
        self.fig.update_layout(
            height=600,
            title=f"ISCRI {self.actor1_code}-{self.actor2_code} : No data",
            yaxis_title="ISCRI",
...
if __name__ == '__main__':
    ...
    # @app.callback(
    #    Output(component_id='div-figure', component_property='style'),
    #    Input('submit-val', 'n_clicks'))
    # def show_hide_figure(_):
    #     if len(d.df) > 0:
