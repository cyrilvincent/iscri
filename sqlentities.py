...
from sqlalchemy.types import BigInteger, Integer, String, Float, CHAR, Date
...
class Event(Base):
    ...
    is_root_event = Column(Integer, nullable=False)
...
class EventActor(Base):
    ...
    __table_args__ = (UniqueConstraint('event_id', 'actor_id', 'num'), Index('event_id', 'actor_id'))
